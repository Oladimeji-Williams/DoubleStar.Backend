// .../CollectDeviceCommandHandler.cs
...
public sealed class CollectDeviceCommandHandler(IRepairTicketRepository repairTicketRepository, IPublisher publisher)
    : IRequestHandler<CollectDeviceCommand, Result>
{
    public async Task<Result> Handle(CollectDeviceCommand request, CancellationToken cancellationToken)
    {
